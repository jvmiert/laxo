...
ProductService.GetProductRetrieveUpdate = {
  methodName: "GetProductRetrieveUpdate",
  service: ProductService,
  requestStream: false,
  responseStream: true,
  requestType: product_pb.ProductRetrieveUpdateRequest,
  responseType: product_pb.ProductRetrieveUpdateReply
};
...
ProductServiceClient.prototype.getProductRetrieveUpdate = function getProductRetrieveUpdate(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(ProductService.GetProductRetrieveUpdate, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
